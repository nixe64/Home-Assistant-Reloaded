"""
Asyncio utilities for Smart Home - The Next Generation.
...
_P = type_ext.ParamSpec("_P")


def fire_coroutine_threadsafe(
    coro: asyncio.coroutines.Coroutine[typing.Any, typing.Any, typing.Any], loop: asyncio.events.AbstractEventLoop
) -> None:
...
def run_callback_threadsafe(
    loop: asyncio.events.AbstractEventLoop, callback: typing.Callable[..., _T], *args: typing.Any
...
def check_loop(
    func: typing.Callable[..., typing.Any], strict: bool = True, advise_msg: str | None = None
) -> None:
...
def protect_loop(func: typing.Callable[_P, _R], strict: bool = True) -> typing.Callable[_P, _R]:
