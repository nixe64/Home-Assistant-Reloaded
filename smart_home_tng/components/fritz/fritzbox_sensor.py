...
_SENSOR_TYPES: typing.Final[tuple[FritzSensorEntityDescription, ...]] = (
    ...
    FritzSensorEntityDescription(
        ...
        native_unit_of_measurement=core.Const.DATA_RATE_KILOBYTES_PER_SECOND,
        icon="mdi:upload",
    ...
    FritzSensorEntityDescription(
        ...
        native_unit_of_measurement=core.Const.DATA_RATE_KILOBITS_PER_SECOND,
        icon="mdi:upload",
        entity_category=core.EntityCategory.DIAGNOSTIC,
    ...
    FritzSensorEntityDescription(
        ...
        native_unit_of_measurement=core.Const.DATA_GIGABYTES,
        icon="mdi:upload",
