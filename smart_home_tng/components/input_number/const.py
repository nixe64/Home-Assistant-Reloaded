...
class Const:
    """Constants for the Input Number Component."""
    ...
    CREATE_FIELDS: typing.Final = {
        ...
        vol.Optional(core.Const.CONF_MODE, default=MODE_SLIDER): vol.In(
    ...
    UPDATE_FIELDS: typing.Final = {
        ...
        vol.Optional(core.Const.CONF_ICON): _cv.icon,
        vol.Optional(core.Const.CONF_UNIT_OF_MEASUREMENT): _cv.string,
        vol.Optional(core.Const.CONF_MODE): vol.In([MODE_BOX, MODE_SLIDER]),
    }
