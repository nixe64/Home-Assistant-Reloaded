...
_STORAGE_KEY: typing.Final = "auth_provider.smart_home_tng"
_LOGGER: typing.Final = logging.getLogger(__name__)


def _disallow_id(conf: dict[str, typing.Any]) -> dict[str, typing.Any]:
    """Disallow ID in config."""
    if core.Const.CONF_ID in conf:
        raise vol.Invalid(
...
class InvalidUser(core.SmartHomeControllerError):
...
@AUTH_PROVIDERS.register("smart_home_tng")
class ShcAuthProvider(AuthProvider):
    """
...
class ShcLoginFlow(LoginFlow):
    ...
    async def async_step_init(
        ...
        if user_input is not None:
            try:
                await typing.cast(
                    ShcAuthProvider, self._auth_provider
...
CONFIG_SCHEMA: typing.Final = vol.All(AUTH_PROVIDER_SCHEMA, _disallow_id)
