...
class LoginFlow(core.FlowHandler):
    ...
    def __init__(self, auth_provider: AuthProvider) -> None:
        ...
        self._created_at = core.helpers.utcnow()
        self._invalid_mfa_times = 0
        self._user: User | None = None
        self._credential: Credentials | None = None
    ...
    async def async_step_mfa(
        ...
        if user_input is not None:
            ...
            if core.helpers.utcnow() > expires:
    ...
    async def async_finish(self, flow_result: typing.Any) -> core.FlowResult:
