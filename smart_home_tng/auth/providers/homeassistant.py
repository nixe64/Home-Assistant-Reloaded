...
@_AUTH_PROVIDERS.register(Const.CORE_COMPONENT_NAME)
class SmartHomeControllerAuthProvider(AuthProvider):
    """
    Auth provider based on a local storage of users in
    Smart Home - The Next Generation config dir."""

    def __init__(self, *args: typing.Any, **kwargs: typing.Any) -> None:
        """Initialize an Smart Home - The Next Generation auth provider."""
    ...
    async def async_login_flow(self, context: dict[str, typing.Any]) -> LoginFlow:
        ...
        return SmartHomeControllerLoginFlow(self, context)
...
class SmartHomeControllerLoginFlow(LoginFlow):
    ...
    async def async_step_init(self, user_input: dict[str, str] = None) -> FlowResult:
        ...
        if user_input is not None:
            try:
                await typing.cast(
                    SmartHomeControllerAuthProvider, self._auth_provider
